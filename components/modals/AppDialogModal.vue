  ...
  <div v-show="open" id="appDialogModal" class="modal-overlay fixed inset-0 z-[220] flex items-center justify-center">
    ...
    <div class="relative ui-panel rounded-3xl w-[92%] max-w-md p-6 shadow-2xl animate-fade-in">
      <div class="flex items-start gap-3 mb-4">
        ...
        <div class="min-w-0">
          <h2 class="ui-modal-title" style="color:var(--color-text)">{{ ui.dialog.title }}</h2>
      ...
      <div class="flex gap-3 justify-end">
        <button v-if="ui.dialog.showCancel" class="ui-button-secondary" @click="cancel">{{ ui.dialog.cancelText || t('webllm_confirm_cancel') }}</button>
        <button
          :class="ui.dialog.danger ? 'ui-button-danger' : 'ui-button-primary'"
          @click="ok"
