    ...
    <div class="flex-shrink-0 px-5 py-3 border-b border-white/5 bg-zinc-950/15 backdrop-blur-2xl">
      <div class="flex items-center justify-between">
        ...
        <div class="flex items-center gap-2 flex-shrink-0">
          ...
          <a href="https://github.com/Hajimides/OpenTavern" target="_blank" rel="noopener noreferrer" id="githubBtn" class="w-8 h-8 rounded-xl glass flex items-center justify-center text-zinc-400 hover:text-zinc-200 hover:bg-white/10 transition-colors" title="GitHub Repository">
